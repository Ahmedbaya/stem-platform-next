...
import { Users, Trophy, Shield, Server } from "lucide-react"
  ...
  return (
    <div className="grid gap-4 grid-cols-2 lg:grid-cols-4">
      <Card>
        ...
        <CardContent>
          <div className="text-xl sm:text-2xl font-bold">2,845</div>
          <p className="text-xs sm:text-sm text-muted-foreground">+120 this month</p>
        </CardContent>
      </Card>
      <Card>
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
        ...
        <CardContent>
          ...
          <p className="text-xs sm:text-sm text-muted-foreground">+8 this month</p>
        </CardContent>
      </Card>
      <Card>
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
